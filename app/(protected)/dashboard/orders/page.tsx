      ...
      <div className="mx-auto max-w-5xl px-4 py-8 space-y-4">
        <header className="space-y-1">
          ...
          <p className="text-sm text-slate-400">
            Pedidos internos e via portal B2B, status, faturamento e acompanhamento da carteira.
          </p>
        </header>
        ...
        <section className="rounded-2xl border border-slate-800 bg-slate-900/70 p-4 text-sm text-slate-200 space-y-3">
          <p>
            ...
            componentes e fluxos específicos do módulo <strong>Pedidos</strong> de acordo
