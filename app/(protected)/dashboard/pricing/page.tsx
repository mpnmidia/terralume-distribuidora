      ...
      <div className="mx-auto max-w-5xl px-4 py-8 space-y-4">
        <header className="space-y-1">
          ...
          <h1 className="text-2xl font-semibold text-slate-50">
            Tabelas de Preço & Ofertas
          </h1>
          <p className="text-sm text-slate-400">
            Configuração de tabelas de preço por região, canal, cliente e gestão de ofertas.
          </p>
        </header>
        ...
        <section className="rounded-2xl border border-slate-800 bg-slate-900/70 p-4 text-sm text-slate-200 space-y-3">
          <p>
            ...
            componentes e fluxos específicos do módulo <strong>Tabelas de Preço & Ofertas</strong> de acordo
